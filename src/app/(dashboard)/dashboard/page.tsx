                            ...
                            {[
                                ...
                                <tr key={i} className="hover:bg-gray-50">
                                    ...
                                    <td className="p-3 flex gap-2">
                                        <button className="flex items-center gap-1 px-3 py-1 rounded border border-gray-300 text-sm text-gray-700 hover:bg-gray-100 cursor-pointer" onClick={() => router.push("/students/123")}>
                                            <Eye className="w-3 h-3" />
                                            View
                                        </button>
                                        <button className="flex items-center gap-1 px-3 py-1 rounded border border-gray-300 text-sm text-gray-700 hover:bg-gray-100 cursor-pointer" onClick={() => router.push("/students/123/edit")}>
